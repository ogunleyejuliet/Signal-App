  ...
  return (
    <div className="space-y-24 py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <section className="relative text-center space-y-8 pt-8 pb-12">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-indigo-600/20 blur-3xl rounded-full pointer-events-none" />
        <div className="absolute top-1/3 left-1/3 w-64 h-64 bg-cyan-500/15 blur-3xl rounded-full pointer-events-none" />

        {/* Floating Signal Pill */}
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full glass-panel border-indigo-500/30 text-xs font-semibold text-indigo-300 mb-2 animate-bounce-slow">
        ...
        <div className="space-y-4 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-white tracking-tight leading-none">
            See how <span className="gradient-text">AI sees you.</span>
          </h1>
      ...
      <section className="space-y-4">
        <div className="text-center space-y-2">
          <Badge variant="info">Live Search Simulator</Badge>
          <h2 className="text-2xl sm:text-3xl font-bold text-white">How Clients Find Freelancers in AI Search</h2>
        ...
        <div className="max-w-4xl mx-auto glass-panel rounded-2xl p-4 sm:p-6 border border-slate-800 shadow-2xl">
          ...
          <div className="bg-slate-950 rounded-xl p-5 border border-slate-800/90 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div className="flex items-center gap-2 text-xs font-mono text-indigo-400">
                ...
                <span>Prompt: "{engineExamples[activeEngine].query}"</span>
              </div>
      ...
      <section className="space-y-8">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-white">Why Modern Freelancers Need Signal</h2>
          <p className="text-sm text-slate-400 max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card hoverEffect className="space-y-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Run automated tests across 20+ realistic client hiring prompts like "Top Next.js developer for fintech MVP" to see if your profile gets cited.
            </p>
          </Card>
      ...
      {/* CTA Box */}
      <section className="glass-panel rounded-2xl p-8 border border-indigo-500/30 text-center space-y-6 bg-gradient-to-b from-indigo-950/30 to-slate-950">
