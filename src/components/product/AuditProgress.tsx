  ...
  return (
    <Card borderVariant="wine" className={`p-4 space-y-3 ${className}`}>
      <div className="flex items-center justify-between">
        <h4 className="text-xs font-bold uppercase tracking-wider text-rose-800">Live Audit Progress</h4>
        <span className="text-[10px] font-mono font-semibold px-2 py-0.5 rounded bg-rose-50 border border-rose-200 text-rose-800">
          Signal Scanner
        </span>
      </div>
        ...
        {steps.map((step) => (
          ...
          >
            ...
            <div>
              ...
              {step.status === 'current' && (
                <span className="inline-flex items-center gap-1 font-bold text-rose-700 animate-pulse">
